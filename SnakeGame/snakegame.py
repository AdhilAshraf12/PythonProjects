...
game_window = pygame.display.set_mode((frame_size_x, frame_size_y))  # Fixed the tuple format
...
def init_vars():
    ...
    direction = "RIGHT"
    head_pos = [120, 60]
    snake_body = [[120, 60]]  # Initialize snake_body as a list of lists
...
# loop that runs the game basically
while True:
    ...
    show_score(1, white, 'consolas', 20)  # Fixed the font name
